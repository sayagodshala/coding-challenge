...
public class ProductCartListAdapter extends BaseAdapter implements OnClickListener {

    public interface ProductCartListListener {
    ...
    private ProductCartListListener listener;
    private ImageLoader mImageLoader;
    private boolean isOpen = false;

    public ProductCartListAdapter(Context context, List<Product> products, ProductCartListListener listener) {
    ...
    public View getView(int position, View cellView, ViewGroup parent) {
        ...
        if (cellView == null) {
            ...
            cellView = layoutInflater.inflate(R.layout.list_item_cart_product, null);
    ...
    static class ViewHolder {
        ...
        LinearLayout linear_selector, layout_price, linear_buttons;
        TextView text_type, text_name, text_description, text_price, txtadd, text_nos;
